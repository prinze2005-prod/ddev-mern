 ...
 * @description This page is for booking a heating and cooling service, it contains a form
*/
  ...
  return (
    <main>
      <Container>
        <br></br>
        <center>
          <h3>Book Heating and cooling service</h3>
        </center>
